...
//
// 범위: 순수 엔진 어댑터 + 레지스트리 등록까지. 함대를 숨김 단계로 주고받는 방 setup 흐름,
// 안개(fog-of-war) redacted view, 실제 ws 바인딩은 후속 이슈로 둔다(이 엔진 상태가 양측 보드를
// 모두 들고 있어도 다른 어댑터와 동일하게 정상 — redaction은 전송/표현 계층 관심사).
