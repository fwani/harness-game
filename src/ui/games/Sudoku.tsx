...
export function Sudoku() {
  // 시작 상태는 application 헬퍼로 무작위 풀이 가능 퍼즐을 만든다(규칙/난수 재구현 금지).
  const [state, setState] = useState<SudokuState>(() => startSudokuGame(rng));
  ...
  return (
    <section className="game">
      ...
      <p className="hint">
        ...
        채우면 클리어입니다. 고정 단서(굵은 숫자)는 편집할 수 없습니다.
      </p>
